...
/* Command-line: gperf -L ANSI-C -N rfcdown_find_block_tag -c -C -E -S 1 --ignore-case -m100 html_block_names.gperf  */
...
#endif
const char *
rfcdown_find_block_tag (register const char *str, register unsigned int len)
{
  enum
    {
      TOTAL_KEYWORDS = 24,
